...
<body>
	...
	<c:set var="show" value="${loginUser}" />
		...
		<table align="center">
			...
			<tr>
				<td colspan="2" align="center" style="padding-top:10px;">
					<input type="button" value="내정보수정" onclick="/sseug-ssag/mypage/profileEdit">&emsp;
					<input type="button" value="회원탈퇴" onclick="/sseug-ssag/mypage/profile">
				</td> 
			</tr>
		</table>
	</form:form>
